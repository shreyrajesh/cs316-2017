...
PI__ const s_productionInfo[] = 
{
     ...
     {275, 2}, // 1: program ->  declaration_list procedure_definition
     {276, 1}, // 2: declaration_list ->  procedure_declaration
     {276, 2}, // 3: declaration_list ->  variable_declaration_list procedure_declaration
     {276, 2}, // 4: declaration_list ->  procedure_declaration variable_declaration_list
     {278, 5}, // 5: procedure_declaration (VOID) ->  VOID NAME '(' ')' ';'
     {277, 9}, // 6: procedure_definition (NAME) ->  NAME '(' ')' #0001 '{' optional_variable_declaration_list #0002 statement_list '}'
     {279, 0}, // 7: #0001 ->  <empty>
     {280, 0}, // 8: #0002 ->  <empty>
     {281, 0}, // 9: optional_variable_declaration_list ->  <empty>
     {281, 1}, // 10: optional_variable_declaration_list ->  variable_declaration_list
     {282, 1}, // 11: variable_declaration_list ->  variable_declaration
     {282, 2}, // 12: variable_declaration_list ->  variable_declaration_list variable_declaration
     {283, 2}, // 13: variable_declaration (';') ->  declaration ';'
     {284, 2}, // 14: declaration (INTEGER) ->  INTEGER NAME
     {284, 2}, // 15: declaration (FLOAT) ->  FLOAT NAME
     {285, 0}, // 16: statement_list ->  <empty>
     {285, 2}, // 17: statement_list ->  statement_list assignment_statement
     {286, 4}, // 18: assignment_statement (ASSIGN) ->  variable ASSIGN arith_expression ';'
     {287, 3}, // 19: arith_expression ('+') ->  arith_expression '+' arith_expression
     {287, 3}, // 20: arith_expression ('-') ->  arith_expression '-' arith_expression
     {287, 3}, // 21: arith_expression ('*') ->  arith_expression '*' arith_expression
     {287, 3}, // 22: arith_expression ('/') ->  arith_expression '/' arith_expression
     {287, 3}, // 23: arith_expression ('(') ->  '(' arith_expression ')'
     {287, 1}, // 24: arith_expression ->  expression_term
     {288, 1}, // 25: expression_term ->  variable
     {288, 1}, // 26: expression_term ->  constant
     {289, 1}, // 27: variable (NAME) ->  NAME
     {290, 1}, // 28: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {290, 1}, // 29: constant (DOUBLE_NUMBER) ->  DOUBLE_NUMBER
     {291, 1}, // 30: program_$ ->  program
};
...
SR__ s_0[] =
{
    { { REQ_TOKEN}, { 10} },                             
    { {       275}, {  1} }, // program                  
    { {       276}, {  2} }, // declaration_list         
    { {       278}, {  3} }, // procedure_declaration    
    { {       282}, {  4} }, // variable_declaration_list
    { {       264}, {  5} }, // VOID                     
    { {       283}, {  6} }, // variable_declaration     
    { {       284}, {  7} }, // declaration              
    { {       261}, {  8} }, // INTEGER                  
    { {       262}, {  9} }, // FLOAT                    
    { {         0}, {  0} },                             
...
{
    { { REQ_DEF}, {  6} },                             
    { {     282}, { 12} }, // variable_declaration_list
    { {     283}, {  6} }, // variable_declaration     
    { {     284}, {  7} }, // declaration              
    { {     261}, {  8} }, // INTEGER                  
    { {     262}, {  9} }, // FLOAT                    
...
{
    { { REQ_TOKEN}, {  7} },                         
    { {       278}, { 13} }, // procedure_declaration
    { {       283}, { 14} }, // variable_declaration 
    { {       264}, {  5} }, // VOID                 
    { {       284}, {  7} }, // declaration          
    { {       261}, {  8} }, // INTEGER              
    { {       262}, {  9} }, // FLOAT                
...
{
    { { REQ_DEF}, {  7} },                                      
    { {     281}, { 26} }, // optional_variable_declaration_list
    { {     282}, { 27} }, // variable_declaration_list         
    { {     283}, {  6} }, // variable_declaration              
    { {     284}, {  7} }, // declaration                       
    { {     261}, {  8} }, // INTEGER                           
    { {     262}, {  9} }, // FLOAT                             
...
{
    { { REQ_TOKEN}, {  9} },                    
    { {       287}, { 35} }, // arith_expression
    { {        40}, { 36} }, // '('             
    { {       288}, { 37} }, // expression_term 
    { {       289}, { 38} }, // variable        
    { {       290}, { 39} }, // constant        
    { {       258}, { 33} }, // NAME            
    { {       257}, { 40} }, // INTEGER_NUMBER  
    { {       259}, { 41} }, // DOUBLE_NUMBER   
    { {         0}, {  0} },                    
};
...
#line 502 "parser.yy"
        {
         ...
         d_val__.ast = num_ast;
         cout << "float " << d_vsp__[0].double_value << "OK\n";
         }
         }
        break;
